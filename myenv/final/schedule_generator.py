...
night_feature = []
for e in range(1,28):
    night_feature.append(tuple([4,3,e,-1]))
...
for index in range(len(summary)):
    ...
    employee_id = None
    shift = None
    if summary[index]['requestee'] == "Claudia":
        employee_id = 1
    elif summary[index]['requestee'] == "Jose" :
        employee_id = 0
    elif summary[index]['requestee'] == "Alba":
        employee_id = 2
    elif summary[index]['requestee'] == "Javier":
        employee_id = 3
    elif summary[index]['requestee'] == "Varun":
        employee_id = 4
            ...
            for d in range(num_days):
                for s in range(num_shifts):
                    if solver.BooleanValue(work[e, s, d]):
                        schedule += shifts[s] + ' '
                        final_roster[e].append(shifts[s])
